...
const CTA = () => {
  return (
    <div className="border border-transparent xl:h-[40rem] rounded-3xl bg-custom flex flex-col justify-between w-full mt-10 lg:mt-44 p-10">
      <div className="flex flex-col text-white items-center gap-3">
        ...
        <div className="flex flex-col lg:flex-row items-center mt-10 gap-6">
          <Link className="border rounded-full w-full text-center lg:w-auto px-6 py-3 border-[#212121] bg-black text-white">
            Donate Now
          </Link>
          <Link className="border rounded-full  text-center w-full lg:w-auto px-6 py-3 border-[#ffffff] bg-white text-black">
            Become a Volunteer
          </Link>
        </div>
      </div>
